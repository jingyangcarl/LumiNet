...
export DATASET_ROOT="/lustre/fsw/portfolios/maxine/users/jingya/data/youtube/The_15_Most_Famous_Buildings/frames_benchmark"
...
for folder in "$DATASET_ROOT"/*/; do
    ...
    DATA_DIR=youtube/The_15_Most_Famous_Buildings/frames_benchmark/$folder_name
